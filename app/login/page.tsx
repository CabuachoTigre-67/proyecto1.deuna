...
import Button from "../components/Button"; // Ajusta la ruta si es necesario (ej: "@/components/Button")
...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Lógica para procesar la autenticación tradicional si la usas
  };
        ...
        <div className="lg:col-span-7 h-full flex flex-col justify-between space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4 text-xs pt-2">
            ...
            <div className="space-y-1">
              ...
              <p className="text-gray-500 leading-tight">
                Busca por ubicación o sector y encuentra tu cancha ideal.
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-gray-500 leading-tight">
                Organiza lo que se compartirá después del partido y divide gastos fácilmente.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 flex justify-center lg:justify-end">
          <div className="w-full max-w-md bg-white border border-gray-200 rounded-3xl p-8 shadow-sm flex flex-col items-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 text-center">
              Inicia sesión en <span className="text-green-500">DeUna!</span>
            </h2>
            ...
            <div className="w-full">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-gray-100 hover:bg-gray-200 border border-gray-200 rounded-xl transition font-bold text-gray-700 text-sm shadow-sm"
              >
